  ...
  return (
    <section className="relative overflow-hidden">
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-l from-base-900/90 via-transparent to-transparent" />
      </div>
      ...
      <div className="container-page relative flex min-h-[62vh] flex-col justify-end py-10 sm:min-h-[70vh]">
        <div className="max-w-2xl animate-fade-up space-y-4">
          <span className="inline-flex items-center gap-2 rounded-full border border-accent/30 bg-accent/10 px-3 py-1 text-xs font-semibold text-accent-soft">
            ...
            اوس مشهور · Trending now
          </span>
          <h1 className="font-pashto text-4xl font-bold leading-tight text-white drop-shadow sm:text-5xl">
            {video.titlePs}
          </h1>
          {artist && (
            <p className="font-pashto text-lg text-slate-200">{artist.namePs}</p>
          )}
          <p className="max-w-xl font-pashto text-sm leading-relaxed text-slate-300 line-clamp-2">
            {video.descriptionPs}
          </p>
